...
const HomePage = () => {
    return (
        <div className="card m-3 border border-1" style={{ width: 840}}>
            <div className="row g-0">
                <div className="col-md-4">
                    <img src={image} className="img-fluid rounded-start"  style={{ width: 280}}alt="personal_phone_book" />
                </div>
                <div className="col-md-8">
                    <div className="card-body">
                        ...
                        <ul className="list-group list-group-numbered" style={{ width: 200}}>
